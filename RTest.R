...
Alpha <- 0.05
qnorm(1 - Alpha/2) # 正态分布显著水平Alpha的分位数
...
apply(mat, 2, sum) # 1:所有行，2：所有列，c(1,2)行和列
...
ListY <- vector("list", 5) # 创建长度5的空list
